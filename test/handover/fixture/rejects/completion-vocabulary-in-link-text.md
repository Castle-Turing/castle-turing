<!-- expect: C-CLAIM — the banned register hidden in markdown link text, which renders in full -->
...
- A second change [is complete and was delivered successfully](https://example.invalid/x) [#12].
