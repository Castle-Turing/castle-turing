<!-- expect: C-STRUCT — an Intent restated from memory, citing no state clause -->
# Handover — 2026-03-01 to 2026-03-07

## Intent

The milestone, as this report remembers it, is that the example change lands and the checker
learns its rules from the fixtures beside it [#11].
